...
maps.createLiveMap = (mapId, options = {}) => {
  ...
  button.className = options.btnClasses || (options.btnType === 'button' ? 'defra-button-secondary defra-button-secondary--icon' : 'defra-link-icon-s')
