...
module.exports = {
  ...
  getStationsByRiverSlug: async (slug) => {
    const response = await db.query(`
      ...
      CASE WHEN type = 'tide' AND measure_with_latest.river_slug is NULL THEN 'sea' ELSE type END AS group_type,
      ...
      WHERE river_catchment_station.river_slug SIMILAR TO $1
