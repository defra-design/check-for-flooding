...
module.exports = {
  getTargetArea: async (id) => {
    ...
    LEFT JOIN targetarea_trigger tt ON LOWER(ta1.fws_tacode) = LOWER(tt.targetarea_id)
    ...
    LEFT JOIN targetarea_trigger tt ON LOWER(ta2.fws_tacode) = LOWER(tt.targetarea_id)
    LEFT JOIN measure_with_latest mwl ON mwl.rloi_id = tt.trigger_id
