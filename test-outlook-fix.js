      ...
      risk_area_blocks: [
        {
          ...
          risk_levels: {
            river: [4, 5], // Substantial impact, expected likelihood - this should appear first (20 points)
            surface: [3, 4], // Significant impact, likely likelihood for region (12 points)
            ground: [3, 4], // Significant impact, likely likelihood for region (12 points)
            coastal: [3, 3] // Significant impact, possible likelihood - this should appear last (9 points)
          }
        }
      ]
    }
